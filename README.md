...
- **[Item Piles](https://foundryvtt.com/packages/item-piles)** + **[Item Piles – Vagabond](https://foundryvtt.com/packages/item-piles-vagabond)** — for loot and item management. Drag and drop the items from the item menu or from the journal directly on the scene.
